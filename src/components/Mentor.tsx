    ...
    <section id="faculty" className="py-16 md:py-24 bg-gradient-to-b from-slate-950 to-gray-800 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold font-poppins text-white mb-4 md:mb-6">Chairperson, District Legal Services Authority</h2>
            ...
            <div className="flex flex-col items-center gap-8 md:gap-12 lg:flex-row">
              ...
              >
                ...
                <motion.p
                  ...
                  viewport={{ once: true }}
                  className="text-neutral-500 text-lg md:text-xl font-medium mb-4 md:mb-6"
                >
                   Ld. District & Sessions Judge-cum-Chairperson, District Legal Services Authority
                </motion.p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold font-poppins text-white mb-4 md:mb-6">Secretary, District Legal Services Authority</h2>
