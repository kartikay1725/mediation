...
export const AnimatedTestimonials = ({
  ...
  const [rotations, setRotations] = useState<number[]>([]); // safe rotations
  const [hasMounted, setHasMounted] = useState(false);

  // Ensure client-only render
  useEffect(() => {
    setHasMounted(true);
    // Generate rotations after mount (client-only)
  ...
  if (!hasMounted || rotations.length !== testimonials.length) return null;
